...
package object register {
  ...
  abstract class ImportError(msg: String, cause: Option[Throwable] = none) extends Exception(msg, cause.orNull)
  case class ReadImportError(msg: String, cause: Throwable) extends ImportError(msg, cause.some)
  ...
  case class DBImportError(msg: String, cause: Throwable) extends ImportError(msg, cause.some)
}
