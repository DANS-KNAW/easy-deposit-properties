...
import nl.knaw.dans.easy.properties.app.graphql.types.{ AddBagNameInput, AddBagNamePayload, AddDepositInput, AddDepositPayload, AddIdentifierInput, AddIdentifierPayload, DeleteDepositsInput, DeleteDepositsPayload, RegisterDepositInput, RegisterDepositPayload, Scalars, SetContentTypeInput, SetContentTypePayload, SetCurationInput, SetCurationPayload, SetDoiActionInput, SetDoiActionPayload, SetDoiRegisteredInput, SetDoiRegisteredPayload, SetSpringfieldInput, SetSpringfieldPayload, UpdateIngestStepInput, UpdateIngestStepPayload, UpdateStateInput, UpdateStatePayload }
